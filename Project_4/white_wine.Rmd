...
M <- cor(wine[,2:length(names(wine ))-1], method = c("pearson"))
corrplot(M,
         method = "circle",
         type="upper",
         tl.col="black",
...
### Description Two
For me, this is the most suprising plot in this report. While there is a correlation between the quality and alcohol (.43), it's not possible to see this correlation in the box plot.
...
I used the following ressources for this project:
